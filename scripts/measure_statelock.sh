...
{
  "advisory_locks_during_an_apply_with_work": $LOCKS_DURING,
  ...
  "advisory_locks_seen_during_a_lone_no_op_apply": $NOOP_MAX,
  "advisory_locks_while_the_doomed_apply_held_one": $LOCKS_BEFORE_KILL,
