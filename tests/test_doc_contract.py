...
IMPLEMENTATIONS: dict[str, str] = {
    "NUMBER": "test_the_readme_boundary_table_matches_the_declared_limits",
    "COMMAND": "test_every_command_the_readme_shows_is_one_this_repository_runs",
    "OUTPUT": "test_the_readme_plan_output_is_the_one_both_binaries_produce",
...
def _resolves(claim: str) -> bool:
    ...
    `quiltz/thing.py` because that is the import path a reader types, and the file is at
    `src/quiltz/thing.py`. Both are correct and a check that refused the first would be wrong.
    """
